...
| `timeout` | `Number` |  | Milliseconds before a [request](https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest/timeout) to the service is automatically terminated. |
